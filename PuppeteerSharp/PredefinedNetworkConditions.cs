// <copyright file="PredefinedNetworkConditions.cs" company="PlaceholderCompany">
...
namespace PuppeteerSharp
{
    ...
    public static class PredefinedNetworkConditions
    {
        ...
        private static readonly Lazy<IReadOnlyDictionary<string, NetworkConditions>> ReadOnlyConditions =
            new(() => new ReadOnlyDictionary<string, NetworkConditions>(Conditions));

        internal static IReadOnlyDictionary<string, NetworkConditions> ToReadOnly() => ReadOnlyConditions.Value;
    }
}
