...
{
    public interface IPupPageRequester : IDisposable
    {
    ...
    public class PupPageRequester : IPupPageRequester
    {
        ...
        public PupPageRequester(CrawlConfiguration config, IWebContentExtractor contentExtractor, HttpClient httpClient = null)
        {
            ...
            if (pupPage1 == null)
                using (pupPage1 = await pupBrowser.NewPageAsync())
                {
                    ...
                    try
                    {
                        ...
                        Response pupResponse1 = await pupPage1.GoToAsync(crawledPage1.Uri.AbsoluteUri);
                        ...
                        await pupPage1.WaitForTimeoutAsync(3000);
                ...
                using (pupPage2 = await pupBrowser.NewPageAsync())
                {
                    ...
                    try
                    {
                        ...
                        Response pupResponse2 = await pupPage2.GoToAsync(crawledPage2.Uri.AbsoluteUri);
                        await pupPage2.WaitForTimeoutAsync(2000);
                        ...
                        await pupPage2.EvaluateExpressionAsync("bE = document.body, bL");
                        await pupPage2.EvaluateExpressionAsync("window.scrollTo({top:bE.offsetTop - bE.offsetHeight,behavior:'smooth'})");
                        await pupPage2.WaitForTimeoutAsync(5000);
        ...
        public virtual async Task<CrawledPage> MakeRequestAsync(Uri uri, Func<CrawledPage, CrawlDecision> shouldDownloadContent)
        {
            ...
            if (httpResponseMessage == null)
            {
                ...
                Uri headerUri = new Uri(uri.GetLeftPart(UriPartial.Authority));
                if (uri == null)
            ...
            await Chromium();
            pupOptions.ExecutablePath = browserFetcher.DownloadAsync().Result.GetExecutablePath();
            ...
            if (pupPage1 == null)
                using (pupPage1 = await pupBrowser.NewPageAsync())
                {
                    ...
                    try
                    {
                        ...
                        await Task.Delay(2000); // await pupPage1.WaitForTimeoutAsync(2000);
                ...
                using (pupPage2 = await pupBrowser.NewPageAsync())
                {
                    ...
                    try
                    {
                        ...
                        await Task.Delay(2000); // await pupPage2.WaitForTimeoutAsync(2000);
        ...
        private async Task Chromium()
        {
            ...
            else
            {
                if (countNum <= 50)
                {
                    ...
                    //revisionInfo = await browserFetcher1.GetRevisionInfoAsync();
                    pupOptions.UserDataDir = chromiumLocalDirPath1;
                }
                else
                {
                    ...
                    //revisionInfo = await browserFetcher2.GetRevisionInfoAsync();
